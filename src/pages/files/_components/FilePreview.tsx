  ...
  ({
    ...
    return (
      <div className="flex flex-col gap-4">
        ...
        {isImage ? (
          <div className="flex justify-center rounded-lg bg-base-200 p-4">
            <img
              src={downloadUrl}
              alt={node.name}
          ...
          <div className="flex flex-col items-center gap-4 rounded-lg bg-base-200 p-8">
        ...
        <div className="flex justify-center">
          <a href={downloadUrl} download={node.name} className="btn btn-sm gap-1">
            <Download size={14} />
            Download
          </a>
        </div>
