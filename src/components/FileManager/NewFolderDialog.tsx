...
export type NewFolderDialogHandle = {
  open: () => void;
};

const NewFolderDialogComponent = forwardRef<
  NewFolderDialogHandle,
  NewFolderDialogProps
>(({ currentFolderId, onCreated, showDefaultTrigger = true }, ref) => {
...
export const NewFolderDialog = memo(NewFolderDialogComponent);
