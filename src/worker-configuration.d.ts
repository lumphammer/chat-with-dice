/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 0cfd1b1e91ce8c7470f7434766b713be)
// Runtime types generated with workerd@1.20260507.1 2026-04-18 global_fetch_strictly_public,nodejs_compat
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "D1_TOKEN" | "CLOUDFLARE_ACCOUNT_ID" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "RESEND_API_KEY" | "RESEND_FROM_EMAIL" | "BUCKET_PUBLIC_URL">> {}
}
