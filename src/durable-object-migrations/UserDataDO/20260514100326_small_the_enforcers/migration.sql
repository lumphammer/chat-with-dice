ALTER TABLE `room_resource_shares` ADD `room_durable_object_id` text NOT NULL;--> statement-breakpoint
...
INSERT INTO `__new_room_resource_shares`(`id`, `room_id`, `node_id`, `shared_time`) SELECT `id`, `room_id`, `node_id`, `shared_time` FROM `room_resource_shares`;--> statement-breakpoint
