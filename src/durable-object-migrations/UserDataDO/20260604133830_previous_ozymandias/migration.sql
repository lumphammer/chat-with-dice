...
CREATE TABLE `__new_nodes` (
	...
	`created_time` integer DEFAULT (unixepoch(CURRENT_TIMESTAMP) * 1000) NOT NULL,
...
INSERT INTO `__new_nodes`(`id`, `name`, `parent_folder_id`, `created_time`, `deleted_time`, `folder_id`, `file_id`) SELECT `id`, `name`, `parent_folder_id`, `created_time`, `deleted_time`, `folder_id`, `file_id` FROM `nodes`;--> statement-breakpoint
