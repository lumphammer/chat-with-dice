...
/**
 * Read a Deck's configuration for its owner to edit: whether Face Down draws
 * are permitted, the current Common Back, and the Deck's image children to pick
 * a back from. Owner-only — this reads the owner's own file store.
 */
