...
**Obstruction** can only be rolled against once, and another **Story Card**
cannot be drawn until that roll is made. Entered from **Setup**, which shuffles
a **Story Deck** if the **Room** has never had one. Resetting the game discards
all of this and returns the **Room** to a blank **Setup**.
