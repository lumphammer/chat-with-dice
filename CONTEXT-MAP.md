...
Chat With Dice splits into four bounded domain contexts, plus a small amount
...
- **Room (chat log) → Cards / Files / Safety**: A chat message may carry text, a dice roll (Roll capability), a Cards **Card Draw Message**, or a Files **Shared Item Message**. The Room owns the log; each capability owns and formats its own message payload.
