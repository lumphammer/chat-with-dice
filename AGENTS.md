...
Multi-context repo — `CONTEXT-MAP.md` at the root points to a `CONTEXT.md` per capability (`src/capabilities/*/CONTEXT.md`); `docs/adr/` is at the root. See `docs/agents/domain.md`.
